...
* Class<type> - обращение к шаблонному классу. type определяет какого типа будут поля создаваемого объекта;
* template<typename T>
* -------------------------------------------
*/
...
/////////////  Кoнец объявление класса - Class declaration end//////////////////
/////////////////////////////////////////////////////////////////////
...
template<typename T>
typename List<T>:: ConstReverseIterator List<T>::ConstReversIterator:: operator++(int)
{
...
template<typename T>
typename List<T>:: ConstReverseIterator&List<T> ::ConstReversIterator::operator--()
{
...
void main()
{
	...
	cout << endl;
#endif // HOME_WORK
	List<double> d_list = { 2.7,3.14,5.8 };
